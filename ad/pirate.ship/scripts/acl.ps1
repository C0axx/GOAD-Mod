...
SetAcl (Get-ADUser "harbor.master") (Get-ADUser "will.turner") "GenericAll" "None"
...
SetAcl (Get-ADUser "captain.hook") (Get-ADGroup "Domain Admins") "GenericAll" "None"
...
SetAcl (Get-ADUser "stanley.Storm") (Get-ADComputer "dc01") "GenericAll" "None"
...
SetAcl (Get-ADUser "peg.leg") (Get-ADGroup "Domain Admins") "WriteProperty" "All"
...
SetAclExtended (Get-ADUser "elizabeth.swann") (Get-ADGroup "Domain Admins") "Self" "bf9679c0-0de6-11d0-a285-00aa003049e2" "None"
...
SetAclExtended (Get-ADUser "stanley.Storm") (Get-ADGroup "Domain Admins") "WriteProperty" "bf9679c0-0de6-11d0-a285-00aa003049e2" "All"
...
SetAclExtended (Get-ADUser "harbor.master") (Get-ADUser "ship.master") "ExtendedRight" "00299570-246d-11d0-a768-00aa006e0529" "None"
...
SetAcl (Get-ADUser "ship.captain") (Get-ADGroup "Domain Admins") "WriteOwner" "None"
...
SetAcl (Get-ADUser "ship.master") (Get-ADUser "will.turner") "GenericWrite" "None"
...
SetAcl (Get-ADUser "harbor.master") (Get-ADGroup "Pirates") "WriteDacl" "None"
